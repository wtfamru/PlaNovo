      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-sm border">
          <div className="px-6 py-4 border-b border-gray-200">
            <h1 className="text-2xl font-bold font-syne text-planovo-dark">Organization Settings</h1>
            <p className="mt-1 text-sm font-syne text-planovo-secondary">Manage your organization settings and members</p>
          </div>
