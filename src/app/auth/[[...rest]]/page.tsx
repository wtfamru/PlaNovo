    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-md w-full space-y-8">
          ...
          {/* Toggle Buttons */}
          <div className="flex bg-planovo-light rounded-lg p-1">
            <button
              onClick={() => setIsSignUp(false)}
              className={`flex-1 py-2 px-4 rounded-md text-sm font-syne font-medium transition-all duration-200 ${
                !isSignUp
                  ? "bg-white text-planovo-dark shadow-sm"
                  : "text-planovo-secondary hover:text-planovo-dark"
              }`}
            >
              Sign In
            </button>
