...
export default function CreateOrganizationPage() {
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right Column - Create Organization Form */}
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-md w-full space-y-8">
          ...
          <div>
            <h2 className="text-3xl font-bold font-syne text-planovo-dark text-center">Create Organization</h2>
            <p className="mt-2 text-center font-syne text-planovo-secondary">Set up your team workspace</p>
          </div>
